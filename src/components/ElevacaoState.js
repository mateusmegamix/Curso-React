...
export default function ElevacaoState() {
    ...
    return(
        <>
        <Nota num={1} nome={'nota1'} nota={notas.nota1} setNota={handlerSetNotas}/>
        <Nota num={2} nome={'nota2'} nota={notas.nota2} setNota={handlerSetNotas}/>
        <Nota num={3} nome={'nota3'} nota={notas.nota3} setNota={handlerSetNotas}/>
        <Nota num={4} nome={'nota4'} nota={notas.nota4} setNota={handlerSetNotas}/>
